...
We will be using data from [Suicide Rates Overview 1985 to 2016](https://www.kaggle.com/russellyates88/suicide-rates-overview-1985-to-2016) and [Mental health service availability](http://apps.who.int/gho/data/node.main.MHFAC?lang=en) to create data visualizations that may aid us in finding these trends. 
